...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich =round(float((higher_education['salary'] == '>50K').sum()/                                            len(higher_education))*100, 1)

    lower_education_rich =round(float((lower_education['salary'] =='>50K').sum()/                                               len(lower_education))*100, 1)
